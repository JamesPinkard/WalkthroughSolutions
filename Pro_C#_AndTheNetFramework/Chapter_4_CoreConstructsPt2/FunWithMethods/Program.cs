...
namespace FunWithMethods
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // used as output parameters, provided the firest time
            ...
            DisplayFancyMessage(message: "Wow! Very Fance indeed!", 
        ...
        // example: static int Add(int x, int y) { return x + y; }
